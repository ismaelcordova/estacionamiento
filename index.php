...
require_once './config/Trabajadores.php';

$secciones = [
    'Administrativo' => obtenerTrabajadores('Administrativo'),
    'Docente'        => obtenerTrabajadores('Docente'),
];
?>
<!DOCTYPE html>
<html lang="es-mx">
...
<body>
    <div class="container">
        <?php if (file_exists('./view/plantillas/navbar.php')) include_once './view/plantillas/navbar.php'; ?>
        <div class="content-wrapper">
            <?php if (file_exists('./view/plantillas/aside.php')) include_once './view/plantillas/aside.php'; ?>
    ...
    document.getElementById("generarPasesBtn").addEventListener("click", () => {
        ...
        window.open(`./view/generar_pase.php?datos=${datos}`, "_blank");
    });
    </script>
    ...
    <script src="./assets/js/filtro_activo.js"></script>
    <script src="./assets/js/editar_celda.js"></script>
    <script src="./assets/js/agregar_trabajador.js"></script>
    <script src="./assets/js/vigencia.js"></script>
    <script src="./assets/js/toggle_columna_vigencia.js"></script>
</body>
</html>